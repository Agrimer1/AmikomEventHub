...
@section('page_subtitle', 'Perbarui detail jabatan kepengurusan.')
    ...
    <div class="max-w-2xl bg-white rounded-[2rem] shadow-sm border p-8">
        <form action="{{ route('admin.jabatan.update', $jabatan->id) }}" method="POST" class="space-y-6">
            ...
            <div class="flex gap-4 pt-4">
                ...
                <a href="{{ route('admin.jabatan.index') }}" class="px-8 py-3 bg-slate-100 text-slate-600 rounded-xl font-bold hover:bg-slate-200 transition text-center">
                    Batal
                </a>
            </div>
        </form>
