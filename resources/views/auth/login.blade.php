...
<body class="bg-indigo-900 text-white min-h-screen flex items-center justify-center p-6">
    <div class="max-w-md w-full bg-white text-slate-900 rounded-[2rem] p-8 shadow-2xl">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-black">Login Akun</h1>
            <p class="text-slate-500">AmikomEventHub Portal</p>
        </div>
        ...
        <!-- Tombol Socialite Google Login -->
        <a href="{{ route('auth.google') }}" class="w-full flex items-center justify-center gap-3 py-4 bg-slate-50 border-2 border-slate-200 rounded-2xl font-bold text-slate-700 hover:bg-slate-100 hover:border-slate-300 transition mb-6 shadow-sm">
        ...
        <div class="relative flex py-2 items-center mb-6">
            ...
            <span class="flex-shrink mx-4 text-xs font-bold text-slate-400 uppercase">Atau Login Manual</span>
            <div class="flex-grow border-t border-slate-200"></div>
        </div>
